...
const About = () => {
  return (
    <div className="border-b border-slate-900 pb-4">
        <motion.h1 whileInView={{opacity: 1, y:0}} initial={{opacity: 0, y: -100}} transition={{duration:1.5}} className='my-20 text-center text-4xl'>About <span className='text-cyan-700'>Me</span></motion.h1>
